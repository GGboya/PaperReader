...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    dismiss: 'Dismiss',
    updateAvailableTitle: 'PaperReader Update Available',
    updateAvailableMessage: version => `PaperReader ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside PaperReader Beta? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'Could not retrieve update information.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'PaperReader Is Up to Date',
    ...
    updateDownloadedTitle: 'PaperReader Update Downloaded',
    updateReady: version => `PaperReader ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace PaperReader in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart PaperReader and run the installer now?',
    ...
    updateInstalled: version => `PaperReader ${version} has been installed.`,
  ...
  zh: {
    ...
    dismiss: '关闭',
    updateAvailableTitle: 'PaperReader 有可用更新',
    updateAvailableMessage: version => `PaperReader ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？PaperReader Beta 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: '未能获取更新信息。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: 'PaperReader 已是最新版本',
    upToDateMessage: '当前已是最新版本。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '当前版本不支持在应用内下载安装包。',
    updateDownloadedTitle: 'PaperReader 更新已下载',
    updateReady: version => `PaperReader ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的 PaperReader，然后重新打开。',
    windowsInstallQuestion: '现在重启 PaperReader 并运行安装程序？',
    ...
    updateInstalled: version => `PaperReader ${version} 已安装。`,
