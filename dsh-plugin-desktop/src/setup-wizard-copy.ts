...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    beta: 'Beta',
    title: 'Set up PaperReader',
    profile: 'Profile',
    welcomeTitle: 'Welcome to PaperReader',
    ...
    communityMarketBody: 'The open market built into PaperReader, including custom data sources.',
    ...
    startUsing: 'Start using PaperReader',
  ...
  zh: {
    ...
    beta: 'Beta',
    title: '设置 PaperReader',
    profile: 'Profile',
    welcomeTitle: '欢迎使用 PaperReader',
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: 'PaperReader 内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
